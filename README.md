...
```bash
   git clone https://github.com/Pawmii/Nexus-Loader.git
````

2. Build the project manually
3. Install it into your **Processor Tycoon** game directory
4. Run the game (expect possible crashes or broken features)
...
This is **not a finished product**. Everything is **work-in-progress**, and compatibility is **not guaranteed**.
Expect **instability and breaking changes** with every update.

---

## 📌 Notes

Nexus Loader leverages **BepInEx** as its modding framework.
It is designed to be **modder-friendly**, but it is still in a **pre-alpha stage**.
